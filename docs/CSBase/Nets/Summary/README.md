...
<div class="img" align="center"><img src="./img/road_of_Internet.png"/><p>
  互联网的发展
</p></div>
...
<div class="img" align="center"><img src="./img/ISP.png"/><p>
  三大 IPS
</p></div>
...
<div class="img" align="center"><img src="./img/ISP_net.png"/><p>
  基于 ISP 的三层结构的因特网
</p></div>
...
<div class="img" align="center"><img src="./img/Circuit_0.png"/><p>
  两两相连的线路交换的电话机 
</p></div>

近乎 $O(n^2)$ 的耗材很是不优雅，于是就有个**交换机**作为交换载体

<div class="img" align="center"><img src="./img/Circuit_1.png"/><p>
  带有中间交换机只要 O(n) 的耗材
</p></div>

从通信资源的分配角度来看，交换（Switching）就是按照某种方式动态地分配传输线路的资源

<div class="h5">电路交换的三个步骤：</div>

1. 建立连接（分配通信资源）
2. 通话（一直占用通信资源）
3. 释放连接（归还通信资源）

<div class="h5">电路交换的特点：</div>
...
<div class="img" align="center"><img src="./img/Packet.png"/><p>
  分组交换网络
</p></div>
...
<div class="h5">假设 A，B，C，D 是分组传输路径所要经过的 4 个结点交换机，纵坐标为时间</div>

<div class="img" align="center"><img src="./img/Switching.png"/><p>
  三种交换方式
</p></div>
...
<div class="h5">报文交换：</div>

- 可以随时发送报文，而不需要事先建立连接；整个报文先传送到相邻结点交换机，全部存储下来后进行查表转发，转发到下一个结点交换机
- 整个报文需要在各结点交换机上进行存储转发，由于不限制报文大小，因此需要各结点交换机都具有较大的缓存空间

<div class="h5">分组交换：</div>
...
<div class="img" align="center"><img src="./img/rate.png"/><p>
  速率及单位之间的转换
</p></div>
...
<div class="img" align="center"><img src="./img/band_width.png"/><p>
  带宽
</p></div>
...
<div class="img" align="center"><img src="./img/tuntu.png"/><p>
  网络吞吐量
</p></div>
...
<div class="h5">总时延 = 发送时延 + 传播时延 + 处理时延 （处理时延 + 排队时延）</div>

<div class="img" align="center"><img src="./img/delay.png"/><p>
  网络时延的计算
</p></div>
...
<div class="img" align="center"><img src="./img/RTT.png"/><p>
  往返时间
</p></div>
...
<div class="img" align="center"><img src="./img/Utilization.png"/><p>
  利用率
</p></div>
...
<div class="img" align="center"><img src="./img/packet_lost.png"/><p>
  丢包率
</p></div>
...
<div class="img" align="center"><img src="./img/NetworkSystem.png"/><p>
  网络体系
</p></div>
...
以下面的客户端访问网页与服务器进行通信的过程中，各层的过程举例：

<div class="img" align="center"><img src="./img/Transmission_process.png"/><p>
  传输过程
</p></div>
