...
- **章节目录：**
  - [概述 —— 整个计算机网络的体系结构](Summary/README.md)
  - [应用层 —— HTTP 到 DNS](Application/README.md)
  - [传输层 —— UDP 到 TCP](Transport/README.md)
  - [网络层 —— IP 与 路由](Internet/README.md)
  <!-- - [链路层与局域网](Link.md) -->
  - [物理层与服务器](Physical/README.md)
- **参考：**
...
<div class="img" align="center"><img src="./img/HTTP_url.png"/><p>
  URL 到页面加载
</p></div>
